...
export class LeaveRepository {
  ...
  async findAllBalances(schoolId: string, academicYearId: string): Promise<(LeaveBalance & { staff_name: string | null })[]> {
    return this.db
      .select({
  ...
  async findTeacherRequests(schoolId: string, staffId?: string): Promise<(TeacherLeaveRequest & { staff_name: string | null })[]> {
