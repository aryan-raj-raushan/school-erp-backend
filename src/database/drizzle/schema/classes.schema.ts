...
export const classes = pgTable(
  ...
  (t) => ({
    idx_school: index('classes_school_id_idx').on(t.school_id),
    idx_school_year: index('classes_school_year_idx').on(t.school_id, t.academic_year_id),
    idx_school_deleted: index('classes_school_deleted_idx').on(t.school_id, t.deleted),
  }),
);
